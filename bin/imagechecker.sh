...
# debug with no exit https://vaneyckt.io/posts/safer_bash_scripts_with_set_euxo_pipefail/
$(echo "local tags are: " && cat /tmp/local.txt) || true
...
$(echo "upstream tags are: " && cat /tmp/upstream.txt) || true
